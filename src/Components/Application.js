...
const useStyles = makeStyles((theme) => ({
  root: {
    display: "flex",
    backgroundColor: "rgb(222,221,232)",
    background:
      "radial-gradient(circle, rgba(222,221,232,1) 0%, rgba(129,115,204,1) 74%, rgba(41,14,194,1) 100%)",
  },
  avatarGrid: {
    paddingTop: "20px",
    paddingLeft: "5px",
  ...
  appBar: {
    ...
    background:
      "linear-gradient(90deg, rgba(131,58,180,1) 0%, rgba(110,95,193,1) 50%, rgba(172,163,230,1) 100%)",
    color: "#E1E1E1",
    boxShadow:
          ...
          <div>
            ...
            >
              ...
              <MenuItem onClick={signOut}>
                <GoSignOut /> &nbsp; Sign Out of ChatNest
              </MenuItem>
            </Menu>
          </div>
        </Toolbar>
